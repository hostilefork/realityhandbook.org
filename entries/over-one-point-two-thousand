...
[me: ("jokingly") {Oh I used to like them back in High School, when I cared more about whether things were good than if they were <i>cool</i>.}]
[cutout: {You still think like that. So does any of this seem familiar to you?}]
[me: {Sort of. I have a lot of experiences that <i>seem</i> familiar. But whenever I go back through dream logs its never the same place twice.}]
