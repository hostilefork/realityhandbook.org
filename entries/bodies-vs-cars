...
[note [[{Remember that there is not a one-to-one correspondence of people to cars. Especially with robot-driven cars:}] ["http://en.wikipedia.org/wiki/DARPA_Grand_Challenge"] [{When the highway fills up with these, it gets tough to go around knocking on windshields saying "hey, anybody in there who doesn't think they can get out??"}]]]
["A question arises:"]
