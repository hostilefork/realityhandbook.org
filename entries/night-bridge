realityhandbook [
    date: 7-Aug-2008/8:25+3:00
    category: 'lucid-dream
    title: {Gonna be a Long Night, Gonna Be All Right, on the Night Bridge}
    slug: %night-bridge
    tags: [conspiracy depeche-mode drugs neutral]
    old: http://realityhandbook.livejournal.com/95920.html
]
...
[note {I had just seen a rather impressive <a href="http://www.youtube.com/watch?v=g8Eycccww6k">demo of Augmented Reality</a> online, where you use video devices you are looking through to overlay imagery that has been referenced onto the real world.}]
...
[me: {Thoughts are great, but let's put you in <i>Category B</i> then. If the thought's not just for me, write it down somewhere and send a link to everyone who might be interested. Now is there anyone here who's in what I'll call <i>Category A</i>... which is people who wanted to speak to *me* in particular?}]
...
[note {I make frequent tirades about how people should be free to have whatever bodies they want and not be stuck with some random luck-of-the-genetic draw. I'm often challenged about whether one's intelligence is something people should be stuck with, or if that too should be allowed to change. <a href="http://www.tampabay.com/features/humaninterest/article740940.ece">We must allow changing it</a>, though within a system which mitigates risks.}]
[chubby-man: "I guess."]
...
[black-man: {Yes, there is clearly something <i>like</i> what you describe going on.}]
...
[black-man: {Ordinarily I would agree with you. But that's <i>ordinarily</i>.}]
