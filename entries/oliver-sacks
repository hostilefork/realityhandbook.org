...
[{<i><a href="http://en.wikipedia.org/wiki/Oliver_Sacks">Oliver Sacks</a> is a well known neuroscientist who writes books about some of the curious cases that he encounters. I wrote him a letter on October 3rd, 2008 -- and as it's been well over 2 months now I'm not expecting a reply. So I'll publish it in an open letter format.</i>}]
[divider]
