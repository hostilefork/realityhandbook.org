realityhandbook [
    ...
    tags: [positive helpful technology names]
]
...
[note {It turns out that "Owens Corning" is actually a partnership name, not someone's full name like "Orville Redenbocker". Michael J. Owens was an <a href="http://en.wikipedia.org/wiki/Michael_Joseph_Owens">inventor of automatic bottling machines</a>, and Corning is actually not a person, but a place: Corning, New York.}]
