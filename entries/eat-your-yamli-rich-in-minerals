...
[quote [[{"So I first found out from a guy named Dick,}] [{who learned from Mr. Wong..."}]]]
...
[note {Lately I have been considering more the potentially malicious usage of symbols like blue diamonds in order to deliberately trigger certain kinds of censorship, as it is a prominent shape in the advertising of Viagra. There is an interesting twist on that here, because YAMLI is apparently the name of an <a href="http://en.wikipedia.org/wiki/Yamli">Arabic search engine</a> which interfaces with Google...and though I don't remember seeing the dots under the Y in the dream, that could explain why I thought of Mueslix which has dots over the u. I'd never heard of this. A note says the word means, literally, "he dictates".}]
