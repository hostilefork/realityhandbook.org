realityhandbook [
    ...
    tags: [helpful technology funny neutral conspiracy]
...
[asian-woman: {Those people are buffoons. They do only what serves them, and no more--when you reveal their mistakes they immediately do everything to cover up their error. The person who <i>would</i> help you is <i>Leftist</i>. As he has not intervened in the past few weeks I'd say odds are he isn't going to in the immediate future.}]
[me: "Why not?"]
...
[me: {I don't get this. Are you trying to say there's some kind of voodoo effect from this particular food? Or that the purchases will trigger some kind of consequence? I've had weird suggestions in dreams before and it's been a policy of mine to <i>not</i> act on them without specific and reasonable justification.}]
...
[quote [["1 Fish Sandwich 3.79<br />"] ["1 Lg Fries 2.19"]]]
[{I used my ATM card and withdrew $20 at the same time. So put <i>that</i> in your Matrix and compute it.)}]
