realityhandbook [
    ...
    category: 'essay
    title: "Queerer than we can suppose"
    slug: %regarding-dawkins-queerer-than-we-can-suppose
    tags: []
    old: http://realityhandbook.livejournal.com/37242.html
]
["I saw this quote from Carl Sagan:"]
[{<i>"It is far better to grasp the Universe as it really is than to persist in delusion, however satisfying and reassuring.}]
...
[{<i>"Sagan was a proponent of the search for extraterrestrial life. He urged the scientific community to listen with radio telescopes for signals from intelligent extraterrestrial lifeforms. So persuasive was he that by 1982, he was able to get a petition advocating SETI published in the journal Science, signed by 70 scientists, including seven Nobel Prize winners. This was a tremendous turnaround in the respectability of this controversial field. Sagan also helped Dr. Frank Drake write the Arecibo message, a radio message beamed into space from the Arecibo radio telescope on November 16, 1974, aimed at informing extraterrestrials about Earth."</i> (from <a href="http://en.wikipedia.org/wiki/Carl_Sagan">Wikipedia</a>)}]
...
[{<lj-embed id="3">}]
[{<object width="425" height="350"><param name="movie" value="http://www.youtube.com/v/1APOxsp1VFw"></param><param name="wmode" value="transparent"></param><embed src="http://www.youtube.com/v/1APOxsp1VFw" type="application/x-shockwave-flash" wmode="transparent" width="425" height="350"></embed></object>}]
["</lj-embed>"]
["A good listen."]
