...
[girl: {If it were French it would be pronounced <i>atillion</i> instead.}]
[me: {But rack or shelf... hm... well, that could be considered home if you're a computer. Like a server rack, you know.}]
[note {It's the brand name for a cancer-treatment drug called <a href="http://en.wikipedia.org/wiki/Tegafur">Tegafur</a>, that I've never heard of.}]
