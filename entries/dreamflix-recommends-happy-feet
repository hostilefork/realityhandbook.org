...
[{<i>(UPDATE: I went and read the movie synopsis for Happy Feet and it turns out it's not just about a tapdancing penguin. That part I knew. The part I didn't know was that his rare tapdancing talent--which causes him to become something of an outcast--becomes the key to communication with humans when he's kidnapped and put in a zoo:}]
