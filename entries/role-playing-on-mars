realityhandbook [
    ...
    tags: [attack conspiracy helpful matrix neutral technology]
...
[me: {No, sorry. I'm really having to go deep here, nearly full memory loss. Something <i>really</i> bad is going on, this is the only way to find it. The perpetrators aren't gamers, they have no sense of fun.}]
[max: {Well, let's get you out of here then. For once, won't it be nice to have some security guards protecting <i>you</i>, instead of getting your ass kicked?}]
