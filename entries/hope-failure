realityhandbook [
    ...
    title: "Hope Failure"
    slug: %hope-failure
    tags: [money technology negative]
...
[note {I don't remember ever hearing about it, but it's not surprising that there is such a neighborhood called <a href="http://en.wikipedia.org/wiki/Brooklyn_Heights,_Brooklyn">"Brooklyn Heights"</a>.}]
