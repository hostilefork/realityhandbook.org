realityhandbook [
    ...
    title: "The Self-Multiplying Business Cards of Azir"
    slug: %self-multiplying-business-cards-of-azir
    tags: [names neutral religion]
    old: http://realityhandbook.livejournal.com/57575.html
]
...
[note {I corrected her with my birthdate and today's date, though I added something I'd heard that all the atoms in your body are replaced every 7 years. However, the study I was trying to quote was cells, not atoms, and it's probably pseudoscience anyway <a href="http://message.snopes.com/showthread.php?t=6684">according to Snopes</a>.}]
...
[note [[{the top current Google hit for Azir is a site describing it as a fictional world for furries, with a rather interesting <a href="http://www.io.com/~hmiller/welcome.html">Welcome Speech</a>}] [quote {Welcome, 21st Century Humans! This world, which we call Azir, is home to many Impossible Gates such as the one you see before you. Through the mysterious powers of the Gates, which open to unpredictable times and places, we of Azir have been enriched by the artistic and intellectual treasures of a dozen worlds. Thanks to the generous contributions of a Mizarian named Skirizai Siprit and a Human named Teamouse Chanezumi, it is now possible to make a small sample of these treasures available to other visitors from their home worlds. Material objects will not pass through the Gate, but visitors are entitled to make as many copies of Azirian treasures as they wish for their own private non-commercial use.}] ["...which is odd, if I do say so myself."]]]
[{I leaned down and there was a business card that looked like it was for <a href="http://en.wikipedia.org/wiki/Maharishi_Mahesh_Yogi">Maharishi Mahesh Yogi</a> (the note I took upon awaking was Maharesh Mahi Yogi, but it could easily have been the other). It was on rough cardstock that seemed like recycled paper, with black writing.}]
