realityhandbook [
    ...
    tags: [attack helpful neutral technology]
...
[woman: {We are <i>(company name)</i>. We did the very early demos...}]
...
[note {I know one person affiliated with this group. A non-<lj user="realityhandbook"> address recently got an email from someone in that group on an unrelated topic, that said merely "Welcome <a href="http://www.manataka.org/page91.html">Shaumbra</a>". Despite the brevity of that message, I replied with a link to this journal. Of Shaumbra, it says: "You're not going crazy, you're just Shaumbra moving into the new energy." It says other things too.}]
...
[man-two: ("exasperated") {But what if... what if you are <i>missing the code you need</i> to understand what you aren't getting?! What then?}]
