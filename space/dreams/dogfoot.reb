realityhandbook [
    ...
    title: "Dogfoot"
    slug: %dogfoot
    tags: [attack dogs neutral sexual]
...
[quote [[{"Here we are, and we now know,}] ["There was never anyone for us but each other,"] ["But we have to tell it to ourselves"] ["I will tell it to me"] ["And you will tell it to you"] [{Now we will know who each other are"}]]]
...
[me: {Why, if you can find me now, could I not be found again just as easily right after I wake up? What makes it <i>hard</i>?}]
