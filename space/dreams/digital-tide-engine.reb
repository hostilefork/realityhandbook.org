realityhandbook [
    ...
    tags: [conspiracy matrix names neutral sexual technology]
...
[her: {No, no, not an attack. I just mean she'll do that eyebrow thing she does when she finds out about us. But I wasn't <i>trying</i> to insult her.}]
...
[me: {Well I'm not <i>afraid</i> of that. But I will have to say that does fall under the set of things I was thinking about when I said 'not gross'.}]
...
[note {The term "frame" was interesting to me, because I heard it sort of the way you might think of a <a href="http://en.wikipedia.org/wiki/Sandbox_(computer_security)">Sandbox</a> in computer security.}]
...
[{<i>(Note 6-4-2008: Saturday would have been February 17, 2007 and I can find no evidence of storms on this date in Sur de Mexico.)</i>}]
