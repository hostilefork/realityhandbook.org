realityhandbook [
    ...
    title: "Avoid GeneX at All Costs"
    slug: %avoid-genex-at-all-costs
    tags: [attack conspiracy helpful neutral religion technology]
    old: http://realityhandbook.livejournal.com/120702.html
]
...
[note [[{His head was smooth and the texture of his head reminded me of certain giant jawbreakers that are white with very light spatters of color...like a Jackson Pollack painting:}] [picture %Jawbreaker.jpg] [{...yet there were no eyes or nose, only a moving square mouth that would open and close.}]]]
...
[being: {Of course that's solved, but that's not <i>necessarily</i> a good thing. Take for instance Genex! Woe to you if they ever get your information.}]
[me: "Gen-X?"]
[being: "Remember that name and stay away at all costs."]
[note [[{Although many companies that do things ranging from inseminating livestock to web design have the name "Genex", there is a project called "GeneX" which is an <a href="http://www.research.ibm.com/journal/sj/402/mangalam.html">open source gene database</a>:}] [quote {The GeneX(tm) project is intended to provide an Open Source database and integrated tool set that will allow researchers to store and evaluate their gene expression data and, moreover, such evaluation will be independent of the technology used to obtain the data.}] ["...which seems like perhaps a more relevant hit."]]]
[me: "Well who are *you*?"]
