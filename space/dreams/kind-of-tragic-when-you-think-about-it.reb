realityhandbook [
    ...
    tags: [attack helpful names neutral technology]
...
[picture %cats.jpg]
[note {I didn't really know this offhand, but Triton is a name for the <a href="http://en.wikipedia.org/wiki/Triton_(mythology)">son of Poseidon</a>...which is rather apropos considering the aquatic focus of this dream!}]
[me: {All right, but tragic <i>how</i>? Throw me a bone, here.}]
[him: "It was Newsom."]
[me: "Newsom?"]
...
[note [[{I was a little vague on whether it was "Newsom" or "Newcomb" but he did not correct me when I tried to repeat it. There are no relevant or interesting hits for "Newsom", but Newcomb has <a href="http://en.wikipedia.org/wiki/Newcomb_paradox">a much better one</a>:}] [quote {Newcomb's paradox can also be related to the question of machine consciousness, specifically if a perfect simulation of a person's brain will generate the consciousness of that person. [3] Suppose we take the Predictor to be a machine that arrives at its prediction by simulating the brain of the Chooser when confronted with the problem of which box to choose. If that simulation generates the consciousness of the Chooser, then the Chooser cannot tell if he is standing in front of the boxes in the real world or in the virtual world generated by the simulation. The "virtual" Chooser would thus tell the Predictor which choice the "real" Chooser is going to make.}] [{...so, bringing up Newcomb would make sense when talking about a simulated consciousness, time travel, memory loss/etc.}]]]
