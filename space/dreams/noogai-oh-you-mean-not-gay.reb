realityhandbook [
    ...
    tags: [conspiracy matrix names neutral sexual]
...
[{<i>(Note 6-6-2008: Reviewing this old dream, I realize that the environment was dark, perhaps like the prison colony Alien 3...}]
[picture %alien3.jpg]
[{...but in feeling, it was rather similar to THX 1138 in terms of brainwashing and regimentation...}]
[picture %thx1138.jpg]
["...in any case, a bunch of trapped bald guys.)</i>"]
...
[note {The service had the word "Tap" in it, like <a href="http://en.wikipedia.org/wiki/Gametap">GameTap</a>, but I believe it was something else.}]
[{The content of the message was a special advertisement, and said that said you would get a special point bonus if you played <i>Waking Life 2</i> as the character Naugai.}]
...
[{<i>(Note/Update 2008: I just noticed that the name noogai3 is used in a fairly famous cartoon about a flash animated character breaking out of the "Matrix" of his world. It is in fact the #1 current YouTube hit for "funny": http://www.youtube.com/watch?v=0_fPV13lKm4 -- it's definitely a strange name to be using.)</i>}]
