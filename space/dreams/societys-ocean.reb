realityhandbook [
    ...
    slug: %societys-ocean
    tags: [conspiracy google neutral technology]
...
[note [[{Though I've never seen such a program, it would be quite possible to write one. In fact, when I did a search for "jpeg to ascii" converters, I found one called <a href="http://csl.sublevel3.org/jp2a/">jp2a</a>. In its samples, it offers precisely the demonstration I tried in the dream--conversion of the Google logo:}] [picture %textgoogle.png] [{...so it's apparently a pretty obvious "first test" of such a program.}]]]
...
[me: {What is the nature of this world? Sometimes I don't know. It's so random, that I wonder if I am actually alone inside my mind. Like maybe this is the default state of the universe, and that life as I know it is just me fooling myself into thinking I'm not alone. Who are you? Is it even <i>possible</i> for you and I to stay here long enough to figure it out?}]
