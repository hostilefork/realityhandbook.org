realityhandbook [
    ...
    title: "Feng Shui Kua"
    slug: %feng-shui-kua
    tags: [conspiracy helpful positive verified]
...
[{<b>bus driver</b>: "They've changed because you were right. An unauthorized account was found, and now we can get this all back in order. It will take a bit of time, but they're already working very fast...as you can see."}]
[{I looked closer at the chairs, and they'd been tagged with some various colors.}]
[{<b>bus driver</b>: (chuckling) "What you're looking at is the origin of the word 'Keane'...if you were wondering about that."}]
...
[note {There is a term in Feng Shui that I did not know before, called <a href="http://fengshui.about.com/od/fengshuicures/qt/kua_number.htm">'Feng Shui Kua'</a>. New word, looks relevant, I'll call that "verified"!}]
