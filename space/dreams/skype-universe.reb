realityhandbook [
    ...
    title: "SkypeUniverse"
    slug: %skype-universe
    tags: [helpful neutral skype technology]
...
[{---------------------- + ---------------------- = Result}]
[{pH (power of hydrogen) pH (power of hydrogen)</pre>}]
...
[{<table bgcolor="yellow"><tr><td><font color="red">I am Homer Simpson Ha Ha D'Oh</font></td></tr></table>}]
