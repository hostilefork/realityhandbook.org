...
[technician: {Well, let's just go ahead and say it. Yes, welcome to 'the future', although we prefer to call our part of it <i>The New Alliance of Souls</i>. Some things are better than you're expecting, and some things are going to be worse than you might think they would be considering how much other progress we've made. We have great infrastructure here in the city, but you don't have to travel very far outside to find some very serious issues that we are having trouble solving. In fact, one of our biggest problems is currently going on in Context.}]
...
[{<b>him</b> "Well, maybe it's a case where I should just give this a running start."}]
...
[someone: "Oh, Red, <i>that's</i> why."]
[note [[{I do like red hair but I'm more into length than caring about the color. The girl looked a bit like this model for <a href="http://www.bustedtees.com/">bustedtees</a> T-shirts...}] [picture %BT-18-1-gallery-5102.jpg] [{...and I'll just say that if any non-human beings are reading this journal and wondering what form to outreach to me in...this would be an absolutely fine choice! Although of course I'm ready to try and embrace quality communication in whatever form it comes, don't get me wrong. I'm just saying.}]]]
...
[indian-man: {No, that wasn't looking, you <i>immediately</i> opened it to try and read the words. Skipping the cover entirely.}]
...
[indian-man: {If this book is by a long-term editor of the <i>New York Times</i>, and this was a major important work in his view, wouldn't you believe that it was on purpose to stretch the font?!}]
